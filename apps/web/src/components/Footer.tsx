...
const socials = [
  {
    label: 'Instagram', href: 'https://instagram.com', brand: '#E4405F', glow: 'rgba(228,64,95,0.4)', icon: '#E4405F',
  ...
  {
    label: 'Facebook', href: 'https://facebook.com', brand: '#1877F2', glow: 'rgba(24,119,242,0.4)', icon: '#1877F2',
  ...
  {
    label: 'TikTok', href: 'https://tiktok.com', brand: '#25F4EE', glow: 'rgba(37,244,238,0.35)', icon: '#25F4EE',
  ...
  {
    label: 'YouTube', href: 'https://youtube.com', brand: '#FF0000', glow: 'rgba(255,0,0,0.4)', icon: '#FF0000',
  ...
  {
    label: 'LinkedIn', href: 'https://linkedin.com', brand: '#0A66C2', glow: 'rgba(10,102,194,0.4)', icon: '#0A66C2',
  ...
  {
    label: 'X', href: 'https://x.com', brand: '#000000', glow: 'rgba(255,255,255,0.25)', icon: '#FFFFFF',
  ...
  {
    label: 'Threads', href: 'https://threads.net', brand: '#000000', glow: 'rgba(255,255,255,0.25)', icon: '#FFFFFF',
  ...
  {
    label: 'Pinterest', href: 'https://pinterest.com', brand: '#E60023', glow: 'rgba(230,0,35,0.4)', icon: '#E60023',
  ...
  {
    label: 'Reddit', href: 'https://reddit.com', brand: '#FF4500', glow: 'rgba(255,69,0,0.4)', icon: '#FF4500',
  ...
  {
    label: 'Bluesky', href: 'https://bsky.app', brand: '#0085FF', glow: 'rgba(0,133,255,0.4)', icon: '#0085FF',
  ...
  {
    label: 'Mastodon', href: 'https://mastodon.social', brand: '#6364FF', glow: 'rgba(99,100,255,0.4)', icon: '#6364FF',
  ...
  {
    label: 'Discord', href: 'https://discord.com', brand: '#5865F2', glow: 'rgba(88,101,242,0.4)', icon: '#5865F2',
  ...
  {
    label: 'Slack', href: 'https://slack.com', brand: '#4A154B', glow: 'rgba(74,21,75,0.4)', icon: '#FFFFFF',
  ...
  {
    label: 'Google Business', href: 'https://google.com/business', brand: '#4285F4', glow: 'rgba(66,133,244,0.4)', icon: '#4285F4',
  ...
  {
    label: 'Snapchat', href: 'https://snapchat.com', brand: '#FFFC00', glow: 'rgba(255,252,0,0.3)', icon: '#FFFC00',
  ...
  {
    label: 'GitHub', href: 'https://github.com', brand: '#181717', glow: 'rgba(255,255,255,0.25)', icon: '#FFFFFF',
  ...
  {
    label: 'WhatsApp', href: 'https://wa.me/5513999999999', brand: '#25D366', glow: 'rgba(37,211,102,0.4)', icon: '#25D366',
  ...
  {
    label: 'E-mail', href: 'mailto:contato@expostacker.com.br', brand: '#EA4335', glow: 'rgba(234,67,53,0.4)', icon: '#EA4335',
        ...
        <div className="flex flex-wrap gap-2.5 justify-center py-6 border-t border-brand-border" aria-label="Redes sociais">
          {socials.map((social) => (
            <a
              ...
              style={{ borderColor: `${social.brand}99`, boxShadow: `0 0 12px ${social.glow}`, color: social.icon }}
              title={social.label}
              aria-label={social.label}
              onMouseOver={(e) => { e.currentTarget.style.background = social.brand; e.currentTarget.style.borderColor = social.brand; e.currentTarget.style.color = '#fff'; }}
              onMouseOut={(e) => { e.currentTarget.style.background = ''; e.currentTarget.style.borderColor = `${social.brand}99`; e.currentTarget.style.color = social.icon; }}
            >
              {social.svg}
            </a>
          ))}
