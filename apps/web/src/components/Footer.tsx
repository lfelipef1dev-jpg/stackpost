      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6 py-12">
        ...
        <div className="flex flex-wrap gap-3 justify-center py-8 border-t border-brand-border mt-10" aria-label="Redes sociais">
          {[
            ...
            { label: 'TikTok', href: '/tiktok-api', color: '#25F4EE', icon: FaTiktok },
            { label: 'YouTube', href: '/youtube-api', color: '#FF0000', icon: FaYoutube },
            { label: 'LinkedIn', href: '/linkedin-api', color: '#0A66C2', icon: FaLinkedin },
            { label: 'X', href: '/x-api', color: '#FFFFFF', icon: FaXTwitter },
            { label: 'Threads', href: '/threads-api', color: '#FFFFFF', icon: FaThreads },
            { label: 'Pinterest', href: '/pinterest-api', color: '#E60023', icon: FaPinterest },
            { label: 'Reddit', href: '/reddit-api', color: '#FF4500', icon: FaReddit },
            { label: 'Bluesky', href: '/bluesky-api', color: '#0085FF', icon: FaBluesky },
            { label: 'Mastodon', href: '/mastodon-api', color: '#6364FF', icon: FaMastodon },
            { label: 'Discord', href: '/discord-api', color: '#5865F2', icon: FaDiscord },
            { label: 'Slack', href: '/slack-api', color: '#FFFFFF', icon: FaSlack },
            { label: 'Google Business', href: '/google-business-api', color: '#4285F4', icon: FaGoogle },
            { label: 'Snapchat', href: '/snapchat-api', color: '#FFFC00', icon: FaSnapchat },
            { label: 'GitHub', href: 'https://github.com/lfelipef1dev-jpg/stackpost', color: '#FFFFFF', icon: FaGithub },
