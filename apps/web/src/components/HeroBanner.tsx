...
const slides: Slide[] = [
  {
    ...
    outcome: 'Uma integração só para toda a presenca da sua marca no maior ecossistema social.',
  ...
  },
  {
    ...
    pain: 'Fazer upload de videos longos e Shorts manualmente atrasa escalas e quebra fluxos de conteúdo.',
    solution: 'Envie videos, Shorts, playlists e thumbnails com upload resumavel e controle total via Data API v3.',
    outcome: 'Seu conteúdo no YouTube sobe automaticamente, no horário certo, sem depender de uploads manual.',
  ...
  },
  {
    ...
    solution: 'Um unico envio para publicar em todas as superficies do Instagram, com alt text, colaboradores, music e primeiro comentário.',
  ...
  },
  {
    ...
    pain: 'TikTok exige fluxos proprios: video, Photo Mode, sons, review status. Sem automacao, você fica fora da trend.',
    solution: 'API oficial de conteúdo com suporte a Video, Photo Mode, hashtags, privacy e commercial sound.',
  ...
  },
  {
    ...
    pain: 'A Gen Z nao está no mesmo lugar que as outras geracoes. Se você nao entrega Stories verticais, nao existe para eles.',
    solution: 'Publique Stories e Spotlight com video 9:16, upload de até 1 GB e som integrado.',
    outcome: 'Chegue a 800 milhoes de usuários com conteúdo autentico, leve e no formato nativo deles.',
  ...
  },
  {
    ...
    solution: 'Crie pins em boards com imagem, video, link de destino e alt text. Integração com catalogos de produto.',
  ...
  },
  {
    ...
    solution: 'Publique texto, mídia, enquetes, GIFs e links. Até 10 imagens ou 1 video no ecossistema Meta.',
  ...
  },
  {
    ...
    solution: 'Envie mensagens por webhook para servidores e canais com até 10 anexos, embeds e formatacao avançada.',
    outcome: 'Automatize alertas, lancamentos e updates direto no canal onde seu publico está engajado.',
  ...
  },
  {
    ...
    outcome: 'Marque presenca no fediverso enquanto seus concorrentes ainda estão parados.',
  ...
  },
  {
    ...
    outcome: 'Centralize atualizacoes do StackPost no Slack, onde seu time já trabalha.',
  ...
  },
  {
    ...
    solution: 'Publique status com 4 mídias, controles de privacidade, spoiler e suporte a instancias personalizadas.',
