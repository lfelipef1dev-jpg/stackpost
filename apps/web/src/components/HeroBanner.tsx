...
const slides: Slide[] = [
  ...
  },
  {
    ...
    solution: 'Um único envio para publicar em todas as superficies do Instagram, com alt text, colaboradores, music e primeiro comentário.',
  ...
  },
  {
    ...
    name: 'TikTok',
    users: '1.5B',
    hook: 'Publique short vídeos onde a atenção do mundo esta.',
  ...
  },
  {
    ...
    pain: 'A Gen Z não está no mesmo lugar que as outras geracoes. Se você não entrega Stories verticais, não existe para eles.',
  ...
  },
  {
    ...
    pain: 'Reddit e o maior fórum da internet, mas postar em subreddits exige respeitar regras, flairs e cultura de cada comunidade.',
  ...
  },
  {
    ...
    pain: 'X e o lugar das noticias e threads, mas postar, responder e acompanhar manualmente não escala.',
  ...
  },
  {
    ...
    pain: 'Pinterest e uma máquina de tráfego orgânico, mas criar pins manualmente e lento e inconsistente.',
    solution: 'Crie pins em boards com imagem, vídeo, link de destino e alt text. Integração com catalogos de produto.',
  ...
  },
  {
    ...
    pain: 'Comunidades de fãs e times internos vivem no Discord, mas notificar todo mundo e manual.',
