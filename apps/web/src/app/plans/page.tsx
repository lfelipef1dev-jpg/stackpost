...
const growthJsonLd = productSchema('StackPost Growth', 'Plano Growth: 8.000 posts/mês, 20 contas sociais, legendas com IA, webhooks.', 89, '/plans');
const scaleJsonLd = productSchema('StackPost Scale', 'Plano Scale: 40.000 posts/mês, contas ilimitadas, MCP server, testes A/B.', 197, '/plans');
