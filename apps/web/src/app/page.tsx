...
const testimonials = [
  { name: 'Vlad M.', role: 'CTO · Persona de exemplo', country: 'EUA', text: 'Testamos praticamente todas as APIs de redes sociais e esta foi de longe a melhor. Super direta na integração e tem tudo que você precisa em recursos.' },
  { name: 'Tucker J.', role: 'Agência · Persona de exemplo', country: 'EUA', text: 'Perfis ilimitados sem taxas por conta é um diferencial enorme se você gerencia vários clientes ou construiu sobre a API.' },
  { name: 'Bruna L.', role: 'Social Media · Persona de exemplo', country: 'Brasil', text: 'Finalmente uma ferramenta que entende o mercado brasileiro. Preço em reais, suporte em português, e funciona com todas as plataformas que preciso.' },
];
  ...
  return (
    <main className="min-h-screen bg-brand-bg pt-16">
      ...
      <section className="py-20 md:py-28 max-w-6xl mx-auto px-4 md:px-6">
        <ScrollReveal className="text-center mb-12">
          <h2 className="font-display text-3xl md:text-4xl font-black tracking-tight text-brand-text mb-4">
            Exemplos de uso (conteúdo demonstrativo)
          </h2>
        </ScrollReveal>
