...
export const DAILY_LIMITS: Record<string, Record<string, PlatformLimits>> = {
  ...
  PRO: {
    ...
    PINTEREST: { posts: 96, comments: 0 },
    REDDIT: { posts: 96, comments: 90 },
    DISCORD: { posts: 100, comments: 100 },
    SLACK: { posts: 100, comments: 100 },
    MASTODON: { posts: 96, comments: 90 },
    BLUESKY: { posts: 96, comments: 90 },
    GOOGLE_BUSINESS: { posts: 96, comments: 0 },
    SNAPCHAT: { posts: 96, comments: 0 },
  },
  BUSINESS: {
    TWITTER: { posts: 96, comments: 0 },
