...
function toUserFacing(code: string, raw: string): string {
  const map: Record<string, string> = {
    ...
    UNAUTHORIZED: 'Credenciais inválidas para esta plataforma.',
    FORBIDDEN: 'Permissão negada pela plataforma.',
    NOT_FOUND: 'Recurso não encontrado.',
    INVALID_MEDIA: 'Arquivo de mídia rejeitado pela plataforma.',
